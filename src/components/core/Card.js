...
import { deleteProduct } from '../admin/apihelper/adminCalls';
...
export const Card=(props)=>{
    ...
    const img=`data:${props.poster.contentType};base64,${Buffer.from(props.poster.data).toString('base64')}`

    const Navigate=useNavigate();
    
    //console.log(props.cload)
    const handleDelete=async(e)=>{
        const data=await deleteProduct(props.id,userId);
        if(data.err){

        }else{
            console.log(data.msg);
            props.cload(data.msg);
        }
    }
    ...
    return(
        ...
        <div className="m-2 border border-zinc-300 shrink-0 rounded shadow hover:shadow-2xl my-5 mx-4 flex flex-col justify-around">
            ...
            <div className="card-body p-2 list-none space-y-2 mx-4 my-2 text-sm h-[1/2]">
                ...
                </svg><span className='inline-flex'>&nbsp;{props.price}/day</span>
                </li>
                ...
                </svg> &nbsp;{props.carAge}kms
                </li>

                <li className='flex'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                </svg> &nbsp;{props.mileage}km/ltr
                </li>
